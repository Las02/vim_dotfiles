...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- require('mini.surround').setup() -- uses n as leader.. which we allready use
  ...
  require 'custom.fzf_zo', -- adds gitsigns recommend keymaps
  require 'custom.quick_edit', -- adds gitsigns recommend keymaps
...
-- vim.keymap.set('n', '<leader>c', toggle_qf)
